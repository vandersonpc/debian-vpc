import { an as sendMessage, G as AUTH_CODE_RECEIVED } from '../chunks/actions-639cd34d.js';
...
function getCookies(cookieString) {
  ...
  return cookieString.split(';').map(x => x.trim().split(/(=)/)).reduce((cookiesObject, currentArray) => ({ ...cookiesObject,
