var API = (function(){
  ...
  var API_URL = 'https://keywordseverywhere.com/service/2/';
  var _apiKey;
  var _country = 'global';
  var _currency = 'usd';
  var _dataSource = 'cli';
  ...
  var isOnline = function(cbProcessResponse){
    var url = API_URL + 'getStatus.php?version=' + version;
    getJSON(url)
      .then(function(json){
  ...
  var getPASFData = function( params, cbProcessResponse ){
    var keyword = params.keyword;
    var src = params.src;
    var useGlobal = params.global;
    var url = 'https://api.keywordseverywhere.com/v1/get_pasf_data';
    if (!_apiKey) {
      cbProcessResponse({
        error_code: 'NO_API_KEY',
        ext_error: 'Please setup a valid API key'
