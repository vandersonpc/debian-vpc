...
ConvertVideoData:function( dataitems)
{
    ...
    for (var i=0; i<dataitems.length; i++) 
    {
		...
		o.originalUrl = item.originalUrl;
...
PlayVideo:function( o)
{
    ...
    fr.jq.setAttr("#idVideoTitleA", "href", o.originalUrl?o.originalUrl:o.url);
    ...
    if ( o.playhtml)    
    {
        o.playhtml = o.playhtml.replace( "src=\"//","src=\"https://");
        fr.removeAllChilds(document.getElementById("idPlayVideoInner"));
...
ShowMsgDlg:function( mode)
{
    if ( mode == 1)
    {
		...
		fr.jq.setVal("#idselectLanguage", t['langKey_country']);
